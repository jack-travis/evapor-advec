...
%We also strangely find some interesting striping in the top-right region where $c$ is large and $E_r$ is large. Since these regions are predicted to be unstable, we can assume that model stability here is dependent on model resolution, and that instability would appear here if the resolution or numerical precision were to be improved.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{samplot_imp2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{exempla_alt_imp.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{stable_imp.png}
